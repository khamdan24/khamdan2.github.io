...
![schematic](Locmade.png){style width:"350" height:"300;"}
**Figure ##:** Showing a example schematic.


## Resouces

The schematic as a PDF download is available [*here*](Loc.pdf), and the Zip folder of the project [*here*](dummyZip.zip).
